                            ...
                            <td class="ml-3 pl-3">
                                ...
                                <?php if ($usuario) : ?>
                                    <form action="valorar_articulo.php" method="GET">
                                        ...
                                        $sent_valoraciones->execute(['usuario_id' => $usuario_id, 'articulo_id' => $producto->getId()]);
                                        ...
                                        <input type="hidden" name="articulo_id" value="<?= $producto->getId() ?>">
