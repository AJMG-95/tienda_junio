...
<head>
    ...
    <script>
        function cambiarEtiqueta(el, id) {
            el.preventDefault();
            const ocultoEtiqueta = document.getElementById('ocultoEtiqueta');
            ocultoEtiqueta.setAttribute('value', id);
        }

        function cambiarModificarEtiqueta(el, id) {
            el.preventDefault();
            const ocultoModificarEtiqueta = document.getElementById('ocultoModificarEtiqueta');
            ocultoModificarEtiqueta.setAttribute('value', id);
        }
    </script>
...
<body>
    ...
    <div class="container mx-auto">
        ...
        <div class="overflow-x-auto relative mt-4">
            <button type="submit" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900" data-modal-toggle="popup-modal-add">Añadir nueva categoría</button>
                    ...
                    <?php foreach ($sent as $fila) : ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 text-center">
                                ...
                                <form action="/admin/editar_etiqueta.php" method="POST" class="inline">
                                    <input type="hidden" name="id" value="<?= $fila_id ?>">
                                    <button type="submit" onclick="cambiarModificarEtiqueta(event, <?= $fila_id ?>)" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900" data-modal-toggle="modificar">Editar</button>
                                </form>
                                <form action="/admin/borrar_etiqueta.php" method="POST" class="inline">
                                    <input type="hidden" name="id" value="<?= $fila_id ?>">
                                    <button type="submit" onclick="cambiarEtiqueta(event, <?= $fila_id ?>)" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" data-modal-toggle="etiqueta-borrar">Borrar</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach ?>
    ...
    <!-- Esto es para borrar -->
    <div id="etiqueta-borrar" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="etiqueta-borrar">
                ...
                <div class="p-6 text-center">
                    ...
                    <form action="/admin/borrar_etiqueta.php" method="POST">
                        <input id="ocultoEtiqueta" type="hidden" name="id">
                        <button data-modal-toggle="etiqueta-borrar" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Sí, seguro
                        </button>
                        <button data-modal-toggle="etiqueta-borrar" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No, cancelar</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Seguro que desea borrar este artículo?</h3>
                    <form action="/admin/editar_etiqueta.php" method="POST">

                        <label for="etiqueta" class="block mb-2 text-sm font-medium">
                            etiqueta:
                            <input type="text" name="etiqueta" id="etiqueta" class="border text-sm rounded-lg w-full p-2.5">
                        </label>
                        <input id="ocultoModificarEtiqueta" type="hidden" name="id">
    ...
    <!-- Esto es para añadir una etiqueta -->
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">¿Seguro que desea borrar este artículo?</h3>
                    <form action="/admin/anyadir_etiqueta.php" method="POST">
                        <label for="etiqueta" class="block mb-2 text-sm font-medium">
                            etiqueta:
                            <input type="text" name="etiqueta" id="etiqueta" class="border text-sm rounded-lg w-full p-2.5">
                        </label>
