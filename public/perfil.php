            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr class="m-2 p-2">
                        ...
                        <td>
                            <form action="/editar_nombre.php" method="POST" class="inline">
                                ...
                                <button type="submit" onclick="modNombre(event, <?= $usuarioObj->getId() ?>)" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900" data-modal-toggle="mod-nombre">Editar</button>
                            </form>
                        </td>
                    </tr>
                    <tr class="m-2 p-2">
                    ...
                    <tr class="m-2 p-2">
                        ...
                        <td>
                            <form action="/editar_passwd.php" method="POST" class="inline">
                                <input type="hidden" name="id" value="<?= $usuarioObj->getId() ?>">
